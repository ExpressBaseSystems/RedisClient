...
var RedisClientJS = function () {
    ...
    this.init = function () {
        ...
        $(`#subkeydiv`).off("click").on("click", this.subClick.bind(this));
    ...
    this.Keyinsertfn = function () {
        if ((($("#txtkey").val() != "")) && ($("#txtval").val())) {
            $.ajax({
                url: "EbRedisManager/Keyvalueinput",
    ...
    this.GroupPatternfn = function () {
        if (($("#txtnm").val() != "") && ($("#txtptn").val() != "")) {
            ...
            $.ajax({
                ...
                url: "EbRedisManager/GroupPattern",
    ...
    this.savelistfn = function (ev) {
        ...
        if (!$.isEmptyObject(ob)) {
            $.ajax({
                url: "EbRedisManager/ListValEdit",
    ...
    this.savehashfn = function (ev) {
        ...
        if (!$.isEmptyObject(ob1)) {
            $.ajax({
                url: "EbRedisManager/HashValEdit",
    ...
    this.StringValEditfn = function () {
        ...
        if (stringval != "") {
            $.ajax({
                url: "EbRedisManager/StringvalEdit",
    ...
    this.Regxfn = function () {
        if ($("#txtregex").val() != "") {
            ...
            var regptn = btoa(ptn);
            $.ajax({
                url: "/EbRedisManager/FindRegexMatch",
                //data: { text :$("#t1").val() },
    ...
    this.SortedsetInsertfn = function () {
        if (($("#txtsortedsetscr").val() != "") && ($("#txtsortedsetval").val() != "")) {
            $.ajax({
                url: "/EbRedisManager/SortedsetInsert",
